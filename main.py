...
with col1:
    ...
    st.markdown("<b><p style='font-family:Cursive;font-weight: bold;font-size:200%;text-align: center; color: #262626;text-shadow: 0 0 10px #f2ffcc;'>Work Experience</p></b>", unsafe_allow_html=True)
