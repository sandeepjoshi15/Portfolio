...
with col1:
    ...
    st.markdown("<b><p style='font-family:Cursive;font-size:400%;text-align: center; color: Black;'>Sandeep Joshi</p></b>", unsafe_allow_html=True)
    ...
    st.markdown("<b><p style='font-family:Cursive;font-size:200%;text-align: center; color: #262626;'>Work Experience</p></b>", unsafe_allow_html=True)
    ...
    st.caption("<h6 color: Grey;'>oAssessed the program’s alignment with strategic objectives through stakeholder interviews and sales force surveys. <br>o Analyzed the program for fairness, pay for performance, biases and fiscal responsibility<br>o Benchmarked the design and performance against key industry standards (e.g. plan type, metrics, leverage, mix)<br>o Synthesized results to create actionable insights to enhance sales compensation program performance</p>", unsafe_allow_html=True)
